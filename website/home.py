...
model = YOLO('website/best.pt')


# -------- CSS STYLING ---------
with open("website/css/style.css") as f:
...
df = pd.read_csv("website/medications.csv")
...
if st.session_state.page == "home":
    ...
    with st.container():
        ...
        st.image("website/images/goals.png", use_container_width=True)
...
# ------------------------------------ HISTORY SECTION -----------------------------------
    ...
    with col1:
        ...
        image = Image.open("website/images/medications.png")
    ...
    with col2:
        ...
        image = Image.open("website/images/refills.png")
        st.image(image, use_container_width=True)
